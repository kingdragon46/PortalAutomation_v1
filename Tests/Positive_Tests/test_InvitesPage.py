...
class Test_InvitesPage(BaseTest):
    ...
    def test_mandatory_fields_error(self):
        ...
        No_of_mandatory_fields = invitepage.singleInvite_get_no_of_mandate_fields() - TestData.MandatoryFields_to_skip
    ...
    def test_invitesList_selectHost(self):
        ...
        invitepage.invitesList_host_guest_dropdown()
        sleep(2)
    ...
    def test_invitesList_selectStatus(self):
        ...
        invitepage.action_chain_click(InvitesPage.InvitesList_VisitorInvites_header)
    ...
    def test_bulkInvite_add_member(self):
        ...
        sleep(3)
        invitepage.bulkInvite_add_to_table()
        sleep(3)