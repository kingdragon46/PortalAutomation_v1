...
class Test_HealthStatus(BaseTest):
    ...
    @pytest.mark.xpass(reason="The test is expected to pass as testing negative health status update cases")
    # @pytest.mark.healthstat
    ...
    @pytest.mark.xpass(reason="The test is expected to pass as testing positive health status update cases")
    # @pytest.mark.healthstat
